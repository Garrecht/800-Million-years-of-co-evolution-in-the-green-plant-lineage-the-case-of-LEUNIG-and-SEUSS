...
**Script 2: Extract beta sheets.py:**  
  Python script for extraction of β-sheets from AlphaFold protein models via PyMol (Abramson et al., 2024; Schrödinger 2010).  

**Script 3: Residue visualization.py:**  
  Python script for visualizing interactions of the LUFS-domain of LUG with SEU in AlphaFold protein models via PyMol (Abramson et al., 2024; Schrödinger 2010).  

**Script 4: Interacting residues.py:**  
  Python script for extraction of interacting residues from AlphaFold protein models via PyMol (Abramson et al., 2024; Schrödinger 2010).  
...
**Script 7: Y2H analysis.R:**  
  R script using the gitter package to measure yeast colony sizes and to determine presence/absence of protein interactions in a Y2H assay (Wagih and Parts, 2021).  
